			...
			<section className='main-section container'>
				...
				<article className='main-article'>
					...
					<div className="text" style={{ color: theme.text }}>
						...
						<p>Наша основная задача - это надежность, безопастность и бесперебойная работа любого IT продукта. Задача не простая и для нас очень ответственная. Тестировщик создаёт сценарии тестирования, прогнозирует сбои и находит ошибки в продуктах на этапе разработки. В результате клиент получает качественный продукт.
</p>
