      ...
      <Suspense fallback={(<div>Loading</div>)}>
        <div className='app'>
          <div className={classPerspective} onClick={closeMenu}>
            ...
            >
              ...
              <Routes>
                ...
                <Route path='/message-contact' element={<MessageContactPage />} />
                <Route path='/message-candidat' element={<CandidatMessagePage />} />
          ...
          <ul className={classNav} >
            ...
            <li className={classLi} onClick={openMenu}><Link style={{ color: theme.text }} to="/data" >База знаний</Link></li>
